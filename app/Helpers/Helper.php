...
if (! function_exists('find_index')) {

       // Helper to find line index by key or pattern
     function find_index($key, $lines, $pattern = null){
        return array_find_key($lines, function($line) use ($key, $pattern) {
            if ($pattern) {
